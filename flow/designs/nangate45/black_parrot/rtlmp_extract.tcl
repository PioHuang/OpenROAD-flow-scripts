...
read_liberty ./platforms/nangate45/lib/fakeram45_256x95.lib
...
set results_dir ./results/nangate45/bp/base
...
file mkdir ./objects/nangate45/bp/base/rtlmp_extract
file mkdir ./reports/nangate45/bp/base
...
if { !$RTLMP_EXTRACT_DUMP_FROM_2_2 } {
  ...
  rtl_macro_placer \
    ...
    -notch_weight 50.0 \
    -report_directory ./objects/nangate45/bp/base/rtlmp_extract \
    -fence_lx 0.0 \
    -fence_ly 0.0 \
    -fence_ux 0.0 \
    -fence_uy 0.0 \
...
set out_csv ./reports/nangate45/bp/base/rtlmp_cluster_groups.csv
set out_txt ./reports/nangate45/bp/base/rtlmp_cluster_membership.txt
set out_flat ./reports/nangate45/bp/base/rtlmp_instance_to_cluster.txt
